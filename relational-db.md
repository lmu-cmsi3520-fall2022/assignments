...
- Make sure to divide the implementation work relatively evenly within your group. Let each member “run point” on some set of tasks so that someone is on top of things but of course allow yourselves to help each other.
